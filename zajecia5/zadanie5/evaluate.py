...
#    model.add(Dense(1, input_dim=X_train.shape[1], activation='sigmoid', kernel_initializer='zeros')) #zmiana funkcji aktywacji i optymizer = 'nadam' -> zad 2
    
    model.add(Dense(10, input_dim=X_train.shape[1], activation='relu', kernel_initializer='normal')) #zadanie 3 zamienic 20 wiersz
    model.add(Dense(5, activation='relu', kernel_initializer='normal')) #zadanie 3 zamienic 20 wiersz
    model.add(Dense(1, activation='sigmoid', kernel_initializer='zeros')) #zadanie 3 zamienic 20 wiersz

    #zadanie4

    # stworzenie funkcji kosztu stochastic gradient descentg
